...
class SlideWidget extends StatelessWidget {
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: (!isAssets) ? NetworkImage(imageLink) : AssetImage(imageLink) as ImageProvider,
                  fit: imageFitMode,
                ),
              ),
            ),
  ...
  List<BoxShadow>? _getSlideBoxShadow(int index, int actualIndex) => (index == actualIndex) ? currentItemShadow : sideItemsShadow;

  double _getSlideTurn(int currentIndex, int actualCurrentIndex) => (currentIndex < actualCurrentIndex)
      ? -pi / turns
