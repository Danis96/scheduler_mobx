...
import 'helper_widgets/arrow_navs.dart';
import 'helper_widgets/indicators_widget.dart';
import 'helper_widgets/slide_widget.dart';
...
class CustomCarouselImageSlider extends StatefulWidget {
  CustomCarouselImageSlider({
    ...
    this.currentItemShadow = const <BoxShadow>[
  ...
  /// Current index of list item
  int currentIndex;

  final void Function(int) onIndexChanged;

  @override
  State<CustomCarouselImageSlider> createState() => _CustomCarouselImageSlider();
}

class _CustomCarouselImageSlider extends State<CustomCarouselImageSlider> {
    ...
    return Stack(
      children: <Widget>[
        Align(
          ...
          child: ValueListenableBuilder<bool>(
            ...
            builder: (BuildContext context, bool isExpand, Widget? child) {
              if (widget.autoPlay) {
                isExpand ? _timer?.cancel() : _autoPlayerTimerStart();
              }
              ...
              return AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: (expandedImage != null)
                        ? DecorationImage(
                            image: (!widget.isAssets) ? NetworkImage(expandedImage!) : AssetImage(expandedImage!) as ImageProvider,
        ...
        ValueListenableBuilder<bool>(
          valueListenable: _isExpandSlide,
          builder: (BuildContext context, bool isExpand, Widget? child) => AnimatedOpacity(
          ...
          child: Column(
            children: <Widget>[
              ValueListenableBuilder<int>(
                ...
                builder: (BuildContext context, int actualIndex, Widget? child) => SizedBox(
              ...
              Visibility(
                ...
                child: ValueListenableBuilder<dynamic>(
                  valueListenable: _currentIndex,
                  builder: (BuildContext context, Object? value, Widget? child) => IndicatorsWidget(
  ...
  Future<void> _goNextPage() async {
    if (_currentIndex.value < widget.imagesLink.length - 1) {
      _currentIndex.value++;
      widget.onIndexChanged(_currentIndex.value);
      _isAutoAnimate = true;
