...
class CustomTappableText extends StatelessWidget {
  const CustomTappableText({
    Key? key,
    @required this.text,
    @required this.links,
    this.onPressed,
    ...
    this.linkStyle = const TextStyle(
      color: Color.fromRGBO(59, 72, 86, 1.0),
      fontSize: 13,
  ...
  Widget build(BuildContext context) {
    ...
    return RichText(text: TextSpan(style: defaultStyle, children: _generateContent()), textAlign: textAlign);
  }
}
